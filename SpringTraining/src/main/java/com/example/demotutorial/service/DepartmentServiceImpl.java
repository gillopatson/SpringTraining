...
public class DepartmentServiceImpl implements DepartmentService{
    ...
    @Override
    public Department lookDepartment(String departmentName) {
        return departmentRepository.searchDepartment(departmentName);
    }

/*
    @Autowired
    public  Department DepartmentRecherche()
    {
